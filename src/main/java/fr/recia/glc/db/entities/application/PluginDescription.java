...
public class PluginDescription extends Application {
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof PluginDescription)) { return false; }
		final PluginDescription other = (PluginDescription) obj;
		if (this.application == null) {
			if (other.application != null) { return false; }
		} else if (!this.application.equals(other.application)) { return false; }
		if (this.nomClass == null) {
			if (other.nomClass != null) { return false; }
		} else if (!this.nomClass.equals(other.nomClass)) { return false; }
		return true;
	}
