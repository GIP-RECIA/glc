...
/**
 * Bean - Entity.
 * APersonne étendu en ResponsableEntreprise.
 * <DL><DT><b>Champs obligatoires :</b></DT>
 * <DD>uid, login, password, cn, sn, displayName, givenName, CategoriePersonne,
 * cleJointure, anneeScolaire, etat, société.</DD></DL>
 * <b>Attention la société est donnée dans le champs structRattachement.</b>
...
public class ResponsableEntreprise extends APersonne implements Serializable {
	...
	private static final long serialVersionUID = -5026827317539622166L;
