...
/**
 * Bean - Entity. APersonne étendu en NonEnseignantEtablissement.
 * <DL>
 * <DT><b>Champs obligatoires :</b></DT>
 * <DD>uid, login, password, cn, sn, displayName, givenName, CategoriePersonne, cleJointure, anneeScolaire, structureRattachement, etat.</DD>
 * </DL>
 *
...
public class NonEnseignantEtablissement extends APersonnel {
	...
	private static final long serialVersionUID = 1302757675822311129L;
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder("NonEnseignantEtablissement [");
